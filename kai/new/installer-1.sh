...
select answer in 'Guided install (recommended)' "Koala's desktop install" "Koala's ThinkPad install"; do
    case "$answer" in
        ...
        "Koala's desktop install") HOST='Alfheim' ; export HOST ; ./koala-personal/koala-personal-installer-1.sh ;;
        "Koala's ThinkPad install") HOST='Asgard' ; export HOST ; ./koala-personal/koala-personal-installer-1.sh
    esac
done
echo
