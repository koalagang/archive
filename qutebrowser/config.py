...
# Dracula Theme
# To download this theme: run `git clone https://github.com/dracula/qutebrowser-dracula-theme.git "$XDG_CONFIG_HOME/qutebrowser/dracula"`
import dracula.draw
...
c.content.javascript.enabled  = False # Acheive NoScript like functionality - see question 9. on the Qutebrowser FAQ
